...
export default class World {
    constructor() {
        ...
        this.ambientLight = new THREE.AmbientLight(
            this.debugObject.ambientColor,
            2.5
        );
        if (this.debug.active) {
            this.debugAmbientLight =
                this.debugFolder.addFolder("Ambient Light");
            this.debugAmbientLight
                ...
                .name("Intensity");
            this.debugAmbientLight
                .addColor(this.debugObject, "ambientColor")
                .name("Color")
                .onChange(() => {
        ...
        this.directionalLight = new THREE.DirectionalLight(
            this.debugObject.directionalColor,
            1
        );
        this.directionalLight.position.set(3, 0.25, 2);
        if (this.debug.active) {
            this.debugDirectionalLight =
            ...
            this.debugDirectionalLight
                ...
                .name("Intensity");
            this.debugDirectionalLight
                .addColor(this.debugObject, "directionalColor")
                .name("Color")
                .onChange(() => {
        ...
        if (this.debug.active) {
            ...
            this.debugGalaxy
                .add(this.galaxyParameters, "count")
                .min(100)
                .max(1000000)
                .step(100)
                .onFinishChange(() => {
                ...
                .name("particle count");
            this.debugGalaxy
                .add(this.galaxyParameters, "size")
                .min(0.001)
                .max(0.1)
                .step(0.001)
                .onFinishChange(() => {
                ...
                .name("particle size");
            this.debugGalaxy
                .add(this.galaxyParameters, "radius")
                .min(0.01)
                .max(20)
                .step(0.01)
                .onFinishChange(() => {
            ...
            this.debugGalaxy
                .add(this.galaxyParameters, "branches")
                .min(2)
                .max(20)
                .step(1)
                .onFinishChange(() => {
            ...
            this.debugGalaxy
                .add(this.galaxyParameters, "spin")
                .min(-5)
                .max(5)
                .step(1)
                .onFinishChange(() => {
                ...
                .name("spin intensity");
            this.debugGalaxy
                .add(this.galaxyParameters, "randomness")
                .min(0)
                .max(2)
                .step(0.01)
                .onFinishChange(() => {
            ...
            this.debugGalaxy
                .add(this.galaxyParameters, "randomnessPower")
                .min(1)
                .max(10)
                .step(0.001)
                .onFinishChange(() => {
                ...
                .name("branch concentration");
            this.debugGalaxy
                .addColor(this.galaxyParameters, "insideColor")
                .onFinishChange(() => {
                    this.generateGalaxy();
                });
            this.debugGalaxy
                .addColor(this.galaxyParameters, "outsideColor")
                .onFinishChange(() => {
                    this.generateGalaxy();
                });
    ...
    generateGalaxy() {
        ...
        const outsideColor = new THREE.Color(
            this.galaxyParameters.outsideColor
        );
        ...
        for (let i = 0; i < this.galaxyParameters.count; i++) {
            ...
            const randomX =
                ...
                (Math.random() < 0.5 ? 1 : -1) *
                this.galaxyParameters.randomness *
                radius;
            const randomY =
                Math.pow(Math.random(), this.galaxyParameters.randomnessPower) *
                (Math.random() < 0.5 ? 1 : -1) *
            ...
            mixedColor.lerp(
                outsideColor,
                radius / this.galaxyParameters.radius
            );
